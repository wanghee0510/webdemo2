...
namespace Music_Store.Controllers
{
    public class SingersController : Controller
    {
        ...
        public SingersController(DbContextDemo context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SingerID,SingerName,BirthDay")] Singer singer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SingerID,SingerName,BirthDay")] Singer singer)
        {
